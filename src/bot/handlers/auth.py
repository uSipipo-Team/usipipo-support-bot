"""Handlers de autenticación invisible para el uSipipo Support Bot."""
...
class AuthHandler:
    """
    Handler para autenticación invisible en Support Bot.
    ...
    async def me_handler(
        ...
        """
        Maneja /me - muestra perfil del usuario en Support Bot.
